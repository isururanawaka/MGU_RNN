...
signal ints: std_logic_vector(63 downto 0);
...
begin
    ...
    ad0 : float_adder port map (clk=>CLK, f1=>A(127 downto 96), 
        f2=>A(95 downto 64), out1=>ints(63 downto 32));
    elem_sums:
        for i in 1 downto 1 generate
